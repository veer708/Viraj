...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="http://t.me/MrLucky7e7_bot")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="http://t.me/MrLucky7e7_bot"),
            InlineKeyboardButton(text="🛠️ channel", url="https://t.me/all_inone_content"),
        ],
    ]
)
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ {𝙇𝙪𝙘𝙠𝙮}"('http://t.me/MrLucky7e7_bot')
